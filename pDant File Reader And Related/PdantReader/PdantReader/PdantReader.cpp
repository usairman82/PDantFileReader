...
int main(int argc, char* argv[])
{
	...
	else
	{
		...
		string userInput = "";
		string userInput2 = "";
		while (1 && (userInput2 != "Quit" && userInput2 !="quit"))
		{
			...
			for (int i = 0; i <gameFile;i++)
			{
				if (userInput == games[i][0])
				{
					...
					if (userInput2 == "Y" || userInput2== "y")
					{
						...
						myGame = (pDantGame*)malloc(304);
						fread(myGame,304,1,pDantGameMap);
